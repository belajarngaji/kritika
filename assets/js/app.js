...
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpweHRiZGF3YWpqeXJ2cXJnaWpkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTYzMTI4OTgsImV4cCI6MjA3MTg4ODg5OH0.vEqCzHYBByFZEXeLIBqx6b40x6-tjSYa3Il_b2mI9NE'; // ganti dengan key asli
...
/* ==============================
   ...
   Revisi: generate 5 soal & tambahkan kategori
============================== */
async function generateQuestions(materialText) {
  try {
    const res = await fetch(API_URL, {
      ...
      body: JSON.stringify({
        message: `Berdasarkan teks berikut (dan *hanya teks ini*), buatkan 5 soal pilihan ganda.
⚠️ Harus sertakan kategori: Analisis, Logika, Evaluasi, Refleksi, Konsistensi.
...
async function init() {
  ...
  btnGenerate.addEventListener('click', async () => {
    ...
    // =========================
    // Siapkan summary dan category tracker
    // =========================
    let total = parsed.questions.length;
    let answered = 0;
    let correctCount = 0;

    // tracker kategori untuk radar chart nanti
